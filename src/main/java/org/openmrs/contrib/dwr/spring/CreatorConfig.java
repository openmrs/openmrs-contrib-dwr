 ...
 * @see AccessControl#addExcludeRule(String, String)
 * @see AccessControl#addRoleRestriction(String, String, String)
 * @see AjaxFilter
 * @see AjaxFilterManager#addAjaxFilter(AjaxFilter, String)
 *
 * @author Bram Smeets
