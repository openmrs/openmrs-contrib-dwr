...
import org.openmrs.contrib.dwr.create.NewCreator;
import org.openmrs.contrib.dwr.filter.ExtraLatencyAjaxFilter;
...
public class DwrNamespaceHandler extends NamespaceHandlerSupport
{
    ...
    /**
     * Registers a new {@link Creator} in the registry using name <code>javascript</code>.
     * @param registry The definition of all the Beans
     * @param javascript The name of the bean in the registry.
     * @param beanCreator The {@link Creator} to register.
