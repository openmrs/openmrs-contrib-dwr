...
import org.openmrs.contrib.dwr.ScriptSession;
...
import org.openmrs.contrib.dwr.util.SwallowingHttpServletResponse;
...
public class DefaultWebContext extends DefaultServerContext implements WebContext
{
     ...
     * @see WebContextFactory.WebContextBuilder#set(HttpServletRequest, HttpServletResponse, ServletConfig, ServletContext, Container)
     */
