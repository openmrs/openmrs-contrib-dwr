...
import org.openmrs.contrib.dwr.extend.AccessDeniedException;
import org.openmrs.contrib.dwr.extend.Creator;
import org.openmrs.contrib.dwr.extend.LoginRequiredException;
...
public class DefaultAccessControl implements AccessControl
{
    ...
    /**
     * We ban some methods from {@link Object}
     * @param method The method that should not be owned by {@link Object}
     */
